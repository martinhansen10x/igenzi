...
import {Colors, Metrics, FontStyles, ParentStyles} from '../../styles/'
...
const brandColor = Colors.primaryColors.powderblue


class SMS2FA extends Component {
    ...
    setTimeout(async () => {
      ...
      try {
        ...
        this.setState({
          spinner: false,
          enterCode: true,
          verification: res //should be res.body
        });
  ...
  render() {
    ...
    let headerText = `Enter your ${this.state.enterCode ? 'verification code' : 'phone number'}`
